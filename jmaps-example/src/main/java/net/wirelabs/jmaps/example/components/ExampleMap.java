...
public enum ExampleMap {
    ...
    VIRT_EARTH_SAT("Virtual Earth Satelite", "VESat.xml", new Coordinate(22.565628, 51.247717)),
    VIRT_EARTH_MAP("Virtual Earth Map", "VEMap.xml", new Coordinate(22.565628, 51.247717)),
    VIRT_EARTH_HYB("Virtual Earth Hybrid", "VEHyb.xml", new Coordinate(22.565628, 51.247717));
