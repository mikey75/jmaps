...
class DirectoryBasedCacheTest {
    ...
    // URL 300 CHARS
    private static final String LONG_URL = TestUtils.getRandomString(300);
    // expected url 250 chars (URL LEN LIMIT)
    private static final String EXPECTED_LONG_KEY = LONG_URL.substring(0,250);
    ...
    private static final File EXPECTED_LONG_FILE = new File(CACHE_DIR, EXPECTED_LONG_KEY);
    ...
    void before() throws IOException {
        ...
        Files.deleteIfExists(EXPECTED_LONG_FILE.toPath());
    }
