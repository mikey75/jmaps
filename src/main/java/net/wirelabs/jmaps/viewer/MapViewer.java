...
import net.wirelabs.jmaps.viewer.map.MapRenderer;
import net.wirelabs.jmaps.viewer.map.layer.Layer;
import net.wirelabs.jmaps.viewer.map.MapManager;
import net.wirelabs.jmaps.viewer.map.MapDefinition;
import net.wirelabs.jmaps.viewer.map.painters.CurrentPositionPainter;
import net.wirelabs.jmaps.viewer.map.painters.MapAttributionPainter;
