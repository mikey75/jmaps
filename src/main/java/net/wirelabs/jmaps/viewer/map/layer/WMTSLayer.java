package net.wirelabs.jmaps.viewer.map.layer;
...
import net.wirelabs.jmaps.viewer.utils.CapabilitiesReader;
import net.wirelabs.jmaps.viewer.map.layer.wmts.Capabilities;
